...
case class CopyingActivity(
  ...
  materials, skills, products, BlueprintActivity.Copying) {

}

object CopyingActivity {
  implicit val copyingActivityReads = (
    Reads.pure(-1L) and
